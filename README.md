...
- WALL·E-style mobile base design
- Autonomous Navigation using **ROS2 + Nav2**
- Real-time **SLAM & Obstacle Avoidance**
- **Voice & Vision Interaction**
- Face & Gesture Tracking
- Multimodal AI integration (Vision + Voice + LLM)
- ESP32 based hardware control
- 3D Printed modular body
...
User  →  Camera / Mic  
      →  AI Perception (Vision + Voice)  
      →  LLM Decision Making  
      →  ROS2 Control Layer  
      →  Motor Driver + Sensors  
      →  Physical Movement & Interaction
