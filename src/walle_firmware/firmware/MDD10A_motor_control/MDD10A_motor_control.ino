...
// MDD10A Connection PINs
#define MDD10A_PWM1 9  // PWM for Motor A
#define MDD10A_PWM2 11 // PWM for Motor B
#define MDD10A_DIRA 8  // Direction for Motor A
#define MDD10A_DIRB 7  // Direction for Motor B
...
void setup() {
  // Init MDD10A Connection PINs
  pinMode(MDD10A_PWM1, OUTPUT);
  pinMode(MDD10A_PWM2, OUTPUT);
  pinMode(MDD10A_DIRA, OUTPUT);
  pinMode(MDD10A_DIRB, OUTPUT);

  // Set Initial Direction
  digitalWrite(MDD10A_DIRA, HIGH); // Forward for Motor A
  digitalWrite(MDD10A_DIRB, HIGH); // Forward for Motor B
  ...
  if (Serial.available()) {
    ...
    // Positive direction
      ...
      if (is_right_wheel_cmd) {
        digitalWrite(MDD10A_DIRA, HIGH); // Forward
        is_right_wheel_forward = true;
      } else if (is_left_wheel_cmd) {
        digitalWrite(MDD10A_DIRB, HIGH); // Forward
    ...
    // Negative direction
      ...
      if (is_right_wheel_cmd) {
        digitalWrite(MDD10A_DIRA, LOW); // Reverse
        is_right_wheel_forward = false;
      } else if (is_left_wheel_cmd) {
        digitalWrite(MDD10A_DIRB, LOW); // Reverse
