...
public:
    ...
    on_configure(const rclcpp_lifecycle::State &)
    {
        ...
        RCLCPP_INFO_STREAM(get_logger(), "Lifecycle Node on_configure() is called");
    ...
    on_activate(const rclcpp_lifecycle::State &state)
    {
        ...
        RCLCPP_INFO_STREAM(get_logger(), "Lifecycle Node on_activate is called");
    ...
    on_deactivate(const rclcpp_lifecycle::State &state)
    {
        ...
        RCLCPP_INFO_STREAM(get_logger(), "Lifecycle Node on_deactivate() is called");
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
    ...
    {   
        sub_.reset();
        RCLCPP_INFO_STREAM(get_logger(), "Lifecycle Node on_cleanup() is called");
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
    ...
    {
        sub_.reset();
        RCLCPP_INFO_STREAM(get_logger(), "Lifecycle Node on_shutdown is called");
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
